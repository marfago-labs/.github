...
**Visibility:** [ner-gold-generator](https://github.com/marfago-labs/ner-gold-generator) and [ner-dataset](https://github.com/marfago-labs/ner-dataset) ([stats](https://marfago-labs.github.io/ner-dataset/)) are public. The rest of the lab (including text-compressor and ner-detector) is work in progress - I will publish those repos soon.
